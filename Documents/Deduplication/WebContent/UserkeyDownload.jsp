	...
	<br><br><br><br><br>
	 ...
	 <section>
       <form action="Download" method="post">
        <h1 style="font-size: 40px;"  >Ownership File key   </h1>
        <br><br><br>
         <input style="width: 500px; height: 40px;" type="text" name="key" >
       <button class="btn btn-success" style="width: 200px; height: 50px; background-color: #42f4b0 ";>GO TO THE FILE</Button>
        </form>
    </section>
