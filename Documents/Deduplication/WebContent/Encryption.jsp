...
<script src="js/jquery.vide.min1.js"></script>
    ...
    <div class="container">
      <div class="row-fluid">
        <div class="span6">
          <h1 style="font-size: 40px;">File Encryption</h1>
        </div>
        <div class="span6">
    ...
    System.out.println("Filename===="+Filename);
         ...
         PreparedStatement ps=con.prepareStatement("SELECT Encryptconent FROM deduplication.fileupload  where filename='"+Filename+"'");
...
<table border="5">
 ...
 <p>&nbsp;</p>
<textarea  rows="10" cols="10" style="width: 400px;"> <%=encontent %></textarea>
</section>
