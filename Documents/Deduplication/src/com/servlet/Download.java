...
System.out.println("Welcome download page");
		...
		String secretkey=i1.getfilekey(filename);
		...
		if(secretkey.equalsIgnoreCase(typingPrivatekey)) {
		...
		try 
			...
			String filepath="E:\\Rajesh workspace\\Deduplication\\WebContent\\Local\\";
